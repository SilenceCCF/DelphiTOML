...
```
    ...
    name := Config.GetStr('server.host', 'localhost');  // supports dot-separated paths
...
The following is the original documentation for ikelaiah's TOML Parser for Free Pascal project:
